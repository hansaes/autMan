...
// 渲染模版
// res.render(
// 	"hello.html",// 模版文件目录 /etc/autMan/views2
// 	{
// 		title: "世界，你好。", data: {
// 			text: "Hello world!",
// 			image: "assets/test.jpeg",// 静态文件目录 /etc/autMan/assets
// 		}
// 	}
// )
...
// var lastTime = autMan.bucketGet(bucket, keyname)
// res.send(lastTime)
// autMan.bucketSet(bucket, keyname, `访问地址：${req.ip()} + \n日期时间：${(new Date()).toLocaleString()}`)
// })
